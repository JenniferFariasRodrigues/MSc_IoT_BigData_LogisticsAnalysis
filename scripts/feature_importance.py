...
# Try to get feature names from the model (safe method)
...
# Verificação preventiva de comprimento
if len(feature_names) != len(rf_importance) or len(feature_names) != len(xgb_importance):
...
# """
# VI Manjaro-feature_importance.py
# ------------------------
# Author: Jennifer Farias Rodrigues
# Date: 17/03/2025
# Description: This script computes feature importance for fuel consumption prediction models.
